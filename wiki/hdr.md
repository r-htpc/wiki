...
* **Dolby Vision/HDR10+ is not discussed here as no stable passthrough options exist on a PC due to licensing**. For dynamic tonemapping, either use [JRiver Media Center's JRVR](https://wiki.jriver.com/index.php/JRVR_-_JRiver_Video_Renderer/Configuration) or [MPV](https://carlosfelic.io/misc/best-mpv-config-2026/) with their own basic support of [HDR10+/DV Profile 5/7M/8](/wiki/video#video-metadatacolor-technologies) per-scene trim metadata tonemapping to [HDR10](/wiki/video#video-metadatacolor-technologies). For static tonemapping, use MPC Video Renderer in [MPC-BE](https://github.com/Aleksoid1978/MPC-BE/releases) with tonemapping to [HDR10](/wiki/video#video-metadatacolor-technologies), else read [this post](https://www.reddit.com/r/htpc/comments/1936n8g/dolby_vision_lldv_now_possible_on_windows_1011/) for other experimental support. Otherwise, buy a [Media Device](/wiki/sample-builds#specialized-dolby-vision--hdr10).  
...
Simple, HDR10 Passthrough and DV/HDR10+ Tonemapping  
